...
const WHATSAPP_URL =
  "https://wa.me/919711754726?text=Hello%2C%20I%27d%20like%20to%20enquire%20about%20a%20stay%20at%20Fyra%20Group.";
...
export function WhatsAppButton() {
  return (
    <motion.a
      ...
      className="fixed z-40 right-4 sm:right-5 flex items-center justify-center rounded-full bg-gold shadow-gold-glow hover:scale-110 transition-smooth group"
      style={{
        width: "52px",
        height: "52px",
