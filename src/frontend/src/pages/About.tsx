      ...
      <section className="bg-background spacing-section">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="font-display text-3xl font-semibold text-foreground mb-6 gold-underline">
          ...
          <div className="relative">
            ...
            <div className="space-y-8">
              {MILESTONES.map((m, index) => (
                ...
                >
                  <span className="font-display text-sm font-semibold text-gold w-14 flex-shrink-0 pt-0.5 text-right">
                    {m.year}
                  </span>
