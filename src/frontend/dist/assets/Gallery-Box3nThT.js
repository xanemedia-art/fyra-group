import { r as reactExports, j as jsxRuntimeExports, C as ChevronRight } from "./index-B49hhkqB.js";
...
function GalleryPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background spacing-section", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-12", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 sm:auto-rows-[220px]", children: GALLERY_ITEMS.map((item, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-0 left-0 right-0 p-3 sm:p-4 translate-y-full group-hover:translate-y-0 transition-smooth", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-muted/30 spacing-section border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-12", children: [
              ...
              "div",
              {
                ...
                children: GUEST_STORIES.map((story, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border shadow-card p-6 sm:p-8 md:p-12 flex flex-col items-center text-center", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "p",
                        {
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("blockquote", { className: "font-display text-base sm:text-lg md:text-xl italic text-foreground leading-relaxed mb-6 sm:mb-8 max-w-2xl", children: [
                        '"',
                        story.quote,
                        '"'
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-border pt-5 sm:pt-6 w-full max-w-xs", children: [
                ...
                children: GUEST_STORIES.map((story, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        className: `block transition-smooth rounded-full ${currentSlide === index ? "bg-gold w-5 h-1.5" : "bg-muted-foreground/40 hover:bg-muted-foreground/60 w-1.5 h-1.5"}`
                      }
                    )
                  },
                  story.author
