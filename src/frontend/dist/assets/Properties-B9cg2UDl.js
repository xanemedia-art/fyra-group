import { j as jsxRuntimeExports, L as Link } from "./index-CGGQSEAl.js";
...
function PropertiesPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background spacing-section", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6 lg:px-12 space-y-20", children: PROPERTIES.map((property, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        viewport: { once: true },
        transition: { duration: 0.6, delay: 0.1 },
        className: `grid grid-cols-1 lg:grid-cols-2 gap-12 items-center ${index % 2 !== 0 ? "lg:[&>*:first-child]:order-2" : ""}`,
        "data-ocid": `property-row-${index}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative overflow-hidden group h-80 lg:h-96", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: property.image,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col justify-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl md:text-4xl font-semibold text-foreground mb-2", children: property.name }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base text-muted-foreground leading-relaxed mb-6", children: property.description }),
