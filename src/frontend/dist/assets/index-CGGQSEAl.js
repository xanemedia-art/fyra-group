const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Home-Ce_X23CO.js","assets/proxy-CwdrCzVW.js","assets/arrow-right-MXiKwPb1.js","assets/map-pin-Be9DzTnP.js","assets/About-gd4CrKcP.js","assets/mountain-D62rVSrt.js","assets/Properties-B9cg2UDl.js","assets/FyraHotel-Dbm4Ja2B.js","assets/Aashiyana-Crl9_7DK.js","assets/Aashapuri-DEjEqzlT.js","assets/Gallery-k788L-Xt.js","assets/Activities-DT0ulpcs.js","assets/Contact-DVHDNN9Z.js"])))=>i.map(i=>d[i]);
...
function Header() {
  ...
  const [propertiesOpen, setPropertiesOpen] = reactExports.useState(false);
  const location2 = useLocation();
  const prevPathRef = reactExports.useRef(location2.pathname);
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    if (prevPathRef.current !== location2.pathname) {
      prevPathRef.current = location2.pathname;
      setMobileOpen(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      className: `fixed top-0 left-0 right-0 z-50 transition-smooth ${scrolled ? "bg-card border-b border-border shadow-refined" : "bg-transparent border-b border-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-6 lg:px-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-xl font-semibold tracking-luxury text-foreground leading-none", children: "FYRA" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-[10px] tracking-wide-xl text-gold uppercase leading-none mt-0.5", children: "GROUP" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "nav",
            {
              ...
              children: NAV_ITEMS.map(
                (item) => item.children ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      "data-ocid": `nav-${item.label.toLowerCase()}`,
                      className: `nav-link flex items-center gap-1 text-foreground ${isActive(item.href) ? "active text-gold" : ""}`,
                      type: "button",
                      onClick: () => setPropertiesOpen(!propertiesOpen),
                      "aria-expanded": propertiesOpen,
                      children: [
                        item.label,
                        /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-3.5 h-3.5 transition-smooth group-hover:rotate-180" })
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-full left-1/2 -translate-x-1/2 pt-3 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border shadow-elevated rounded-md py-1.5 min-w-[200px]", children: item.children.map((child) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Link,
                    {
                      to: child.href,
        ...
        mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex flex-col px-6 py-4 gap-1", children: [
              NAV_ITEMS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
                    to: item.href,
                    className: `block py-3 text-sm font-body tracking-wide border-b border-border transition-smooth ${isActive(item.href) ? "text-gold" : "text-foreground hover:text-gold"}`,
                    children: item.label
                  }
                ),
                item.children && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pl-4", children: item.children.slice(1).map((child) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
                    to: child.href,
...
function StickyBookBar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-12 h-14 flex items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarDays, { className: "w-4 h-4 text-forest opacity-70 flex-shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-forest text-sm font-semibold tracking-wide hidden sm:block", children: "Book Your Stay" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-forest text-xs opacity-60 hidden md:block", children: "— Curated Himalayan Experiences" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:flex items-center gap-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-forest opacity-30 text-xs", children: "|" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
...
const WHATSAPP_URL = "https://wa.me/919876543210?text=Hello%2C%20I%27d%20like%20to%20enquire%20about%20a%20stay%20at%20Fyra%20Group.";
function WhatsAppButton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "a",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex items-center justify-center w-full h-full rounded-full bg-gold border-2 border-forest/10 group-hover:bg-[#25D366] transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          MessageCircle,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute right-full mr-3 whitespace-nowrap bg-forest text-gold text-xs font-body px-3 py-1.5 rounded opacity-0 group-hover:opacity-100 transition-smooth pointer-events-none shadow-elevated", children: "Chat with Concierge" })
      ]
    }
  );
}
...
function Layout({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 pt-20 pb-14", children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-forest text-card pb-14 border-t border-foreground/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-12 pt-16 pb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-display text-2xl font-semibold tracking-luxury text-gold leading-none", children: "FYRA" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-[10px] tracking-wide-xl text-gold/60 uppercase leading-none mt-1", children: "GROUP" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-card/60 leading-relaxed max-w-[220px]", children: "Himalayan luxury retreats in Manali. Where grandeur meets stillness." }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-body text-xs tracking-wide-xl text-gold/70 uppercase mb-5", children: "Our Properties" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: PROPERTY_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: link.href,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-body text-xs tracking-wide-xl text-gold/70 uppercase mb-5", children: "Explore" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: FOOTER_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: link.href,
              className: "font-body text-sm text-card/60 hover:text-gold transition-smooth",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-body text-xs tracking-wide-xl text-gold/70 uppercase mb-5", children: "Contact" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("address", { className: "not-italic space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-sm text-card/60", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                children: "info@fyragroup.com"
              }
            )
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-card/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs text-card/40 text-center md:text-left", children: [
          "© ",
          year,
          " Fyra Group. All rights reserved. Manali, Himachal Pradesh."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs text-card/30 text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(StickyBookBar, {})
  ] });
}
const HomePage = reactExports.lazy(
  () => __vitePreload(() => import("./Home-Ce_X23CO.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0).then((m) => ({ default: m.HomePage }))
);
const AboutPage = reactExports.lazy(
  () => __vitePreload(() => import("./About-gd4CrKcP.js"), true ? __vite__mapDeps([4,1,5,2]) : void 0).then((m) => ({ default: m.AboutPage }))
);
const PropertiesPage = reactExports.lazy(
  () => __vitePreload(() => import("./Properties-B9cg2UDl.js"), true ? __vite__mapDeps([6,1,3,2]) : void 0).then((m) => ({ default: m.PropertiesPage }))
);
const FyraHotelPage = reactExports.lazy(
  () => __vitePreload(() => import("./FyraHotel-Dbm4Ja2B.js"), true ? __vite__mapDeps([7,3,1,2]) : void 0).then((m) => ({ default: m.FyraHotelPage }))
);
const AashiyanaPage = reactExports.lazy(
  () => __vitePreload(() => import("./Aashiyana-Crl9_7DK.js"), true ? __vite__mapDeps([8,3,1,2]) : void 0).then((m) => ({ default: m.AashiyanaPage }))
);
const AashapuriPage = reactExports.lazy(
  () => __vitePreload(() => import("./Aashapuri-DEjEqzlT.js"), true ? __vite__mapDeps([9,3,1,5,2]) : void 0).then((m) => ({ default: m.AashapuriPage }))
);
const GalleryPage = reactExports.lazy(
  () => __vitePreload(() => import("./Gallery-k788L-Xt.js"), true ? __vite__mapDeps([10,1]) : void 0).then((m) => ({ default: m.GalleryPage }))
);
const ActivitiesPage = reactExports.lazy(
  () => __vitePreload(() => import("./Activities-DT0ulpcs.js"), true ? __vite__mapDeps([11,1,2]) : void 0).then((m) => ({ default: m.ActivitiesPage }))
);
const ContactPage = reactExports.lazy(
  () => __vitePreload(() => import("./Contact-DVHDNN9Z.js"), true ? __vite__mapDeps([12,1,3]) : void 0).then((m) => ({ default: m.ContactPage }))
);
function PageLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-[60vh] flex flex-col gap-4 items-center justify-center p-12", children: [
