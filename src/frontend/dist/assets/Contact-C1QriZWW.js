import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, R as React, b as clsx, d as cn, o, v as vt, u as useLocation, M as MessageCircle, a as ChevronDown } from "./index-B49hhkqB.js";
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            style: { "--sel-accent": selected.accent },
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm font-medium text-foreground tracking-wide min-w-[140px] text-left", children: selected.label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: open && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: CONTACT_PROPERTIES.map((prop) => {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col min-w-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          ...
                          style: { color: isActive ? prop.accent : void 0 },
                          children: prop.label
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-[10px] tracking-wide text-muted-foreground", children: prop.tagline })
                    ] }),
...
function ContactDetailsCard({ property }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 mt-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm font-medium text-foreground", children: "Address" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground mt-1 leading-relaxed", children: property.address })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm font-medium text-foreground", children: "Phone" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm font-medium text-foreground", children: "Email" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm font-medium text-foreground", children: "WhatsApp" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  style: { color: property.accent },
                  children: "Reservations Hours"
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-muted-foreground", children: "Mon–Sat" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-foreground", children: "9am – 8pm IST" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-muted-foreground", children: "Sunday" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-foreground", children: "10am – 5pm IST" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-muted-foreground", children: "WhatsApp" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-foreground", children: "24 / 7" })
                ] })
              ] })
            ]
          }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground mt-2 px-1", children: "Map placeholder — paste your Google Maps embed src here" })
      ]
    },
    `map-${propertyKey}`
  ) });
...
function InquiryForm() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border shadow-card p-6 sm:p-8 md:p-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl sm:text-2xl font-semibold text-foreground mb-6 sm:mb-8", children: "Reservation Enquiry" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", noValidate: true, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              ...
              children: [
                ...
                INQUIRY_PROPERTIES.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: p.value, children: p.label }, p.value))
              ]
            }
          )
        ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: submitting ? "Sending Enquiry…" : "Send Reservation Enquiry"
        }
      )
    ] })
  ] });
...
function ContactPage() {
  ...
  const [selectedKey, setSelectedKey] = reactExports.useState(() => {
    ...
    return valid.includes(prop) ? prop : "fyra-group";
  });
  reactExports.useEffect(() => {
    const params = new URLSearchParams(location.search);
    const prop = params.get("property");
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-muted/30 spacing-section border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.p,
        {
          ...
          children: "Our concierge team is available to help you plan a perfect Himalayan escape. Reach out anytime."
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(PropertySelector, { selected, onChange: setSelectedKey })
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl sm:text-3xl font-semibold text-foreground", children: selected.label })
          ]
        },
        `${selectedKey}-header`
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: isGroup ? (
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(ContactDetailsCard, { property: selected }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(InquiryForm, {}) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                PropertyMapEmbed,
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            className: "space-y-10",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:col-span-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ContactDetailsCard, { property: selected }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display text-xl sm:text-2xl font-semibold text-foreground mb-6 leading-snug", children: [
                          "Reach Our Team",
                          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                          "at ",
                          selected.label
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground leading-relaxed mb-8", children: "For reservations, special arrangements, or any enquiries specific to this property, our dedicated team is here to assist you. You can reach us by phone, email, or WhatsApp anytime." }),
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "a",
                            {
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-[10px] tracking-wide text-muted-foreground uppercase", children: "Phone" }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm font-medium text-foreground group-hover/item:underline", children: selected.phone })
                                ] })
                              ]
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "a",
                            {
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-[10px] tracking-wide text-muted-foreground uppercase", children: "Email" }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm font-medium text-foreground group-hover/item:underline break-all", children: selected.email })
                                ] })
                              ]
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs(
                            "a",
                            {
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-[10px] tracking-wide text-muted-foreground uppercase", children: "WhatsApp" }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm font-medium text-foreground group-hover/item:underline", children: selected.whatsapp })
                                ] })
                              ]
                            }
                          )
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs text-muted-foreground", children: [
                            "For group reservations or event enquiries, please contact",
                            " ",
                            /* @__PURE__ */ jsxRuntimeExports.jsx(
                              "button",
                              {
                                ...
                                style: { color: selected.accent },
                                children: "Fyra Group central reservations"
                              }
                            ),
                            "."
                          ] })
