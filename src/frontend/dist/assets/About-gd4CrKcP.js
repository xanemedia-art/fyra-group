...
function AboutPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        className: "relative h-[60vh] flex items-center parallax-bg overflow-hidden",
        style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-3xl mx-auto px-6 text-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.h1,
              {
                ...
                className: "font-display text-4xl md:text-5xl font-semibold text-card leading-[1.15] mb-6",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.p,
              {
                ...
                className: "font-body text-base text-card/70 leading-relaxed",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-semibold text-foreground mb-6 gold-underline", children: "Born From a Love of the Mountains" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base text-muted-foreground leading-relaxed mb-4", children: "Their first property, Fyra Hotel, opened to immediate acclaim — not for spectacle, but for restraint. Clean lines, local materials, rooms designed to make the mountain the protagonist." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base text-muted-foreground leading-relaxed", children: "Fifteen years and three properties later, that founding principle remains unchanged: the Himalayas are the luxury. Our job is simply to get out of the way." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          className: "relative h-80 lg:h-[440px] overflow-hidden",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-muted/30 spacing-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 lg:px-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-semibold text-foreground", children: "What Guides Us" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8", children: VALUES.map((value, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          initial: { opacity: 0, y: 20 },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background spacing-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-semibold text-foreground", children: "Milestones" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-[68px] top-0 bottom-0 w-px bg-border" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-8", children: MILESTONES.map((m, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-sm font-semibold text-gold w-14 flex-shrink-0 pt-0.5 text-right", children: m.year }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1 pl-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-0 top-1.5 w-2 h-2 rounded-full bg-gold -translate-x-1" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground leading-relaxed", children: m.event })
              ] })
            ]
          },
          m.year
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-forest py-20 text-center px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl text-gold mb-4", children: "Come Stay With Us" }),
